...
const T = {
  de: {
    ...
    strasse: 'Straße & Hausnummer (in Spanien)', plz: 'Postleitzahl (in Spanien)', ort: 'Wohnort (in Spanien)',
  ...
  en: {
    ...
    strasse: 'Street & house number (in Spain)', plz: 'Postcode (in Spain)', ort: 'City (in Spain)',
    ...
    <div>
      ...
      <div style={{ marginTop: 20, marginBottom: 16 }}>
        <label style={{
          ...
          color: attempted && !data.unfallfrei ? '#b91c1c' : '#1a1a2e'
        }}>
      ...
      <div style={{ marginBottom: 24 }}>
        <label style={{
          display: 'block', marginBottom: 10,
          color: attempted && !data.fahrer_unter_25 ? '#b91c1c' : '#1a1a2e'
        }}>
